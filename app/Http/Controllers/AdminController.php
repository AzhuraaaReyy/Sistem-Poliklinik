...
class AdminController extends Controller
{
    ...
    public function storedokter(Request $request)
    {
        $request->validate([
            ...
            'no_hp' => 'required|numeric|digits_between:12,13|unique:users,no_hp',
    ...
    public function storepasien(Request $request)
    {
        ...
        $request->validate([
            'nama' => 'required|string',
            'no_ktp' => 'required|numeric|digits:16|unique:pasien,no_ktp',
            'alamat' => 'required|string',
            'email' => 'required|email|unique:users',
            'no_hp' => 'required|numeric|digits_between:12,13|unique:users,no_hp',
    ...
    {
        $request->validate([
            'kode_poli' => ['required', 'string', 'regex:/^[A-Z]+$/', 'unique:poli,kode_poli'],
